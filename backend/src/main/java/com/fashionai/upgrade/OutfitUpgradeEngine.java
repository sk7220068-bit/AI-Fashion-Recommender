 ...
 *   Output: Replace sneakers → boots, Add blazer, Consider dark jeans or dress trousers
 */
@Slf4j
@Component
public class OutfitUpgradeEngine {
     ...
     * Each entry lists items to avoid, items to prefer, and a minimum formality level.
     */
    private static final Map<String, OccasionRule> OCCASION_RULES = Map.of(
            ...
            "work", new OccasionRule(
                    ...
                    List.of("blazer", "formal trousers", "formal shirt", "heels", "oxford shoes", "pencil skirt"),
                    0.75
            ),
            ...
            "formal", new OccasionRule(
                    ...
                    List.of("suit", "evening dress", "heels", "formal shirt", "tie", "oxford shoes"),
                    0.90
            ),
    ...
    private static final Map<String, Map<String, String>> UPGRADE_SUGGESTIONS = Map.of(
            ...
            "work", Map.of(
                    "sneakers",  "Replace sneakers with loafers or oxford shoes for a professional look",
     ...
     * @param occasion       target occasion (party | work | casual | date | formal | sport)
     * @param compatScore    pre-computed outfit compatibility score from CompatibilityScorer
    ...
    private String buildSummary(String occasion,
        ...
        if (toReplace.isEmpty() && toAdd.isEmpty()) {
            ...
            if (!toAdd.isEmpty()) {
                sb.append(String.format("You could also add: %s to complete the look.", String.join(", ", toAdd)));
            }
        }
        return sb.toString();
    }
